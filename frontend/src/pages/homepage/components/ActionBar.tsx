      ...
      {actions.map((action) => {
        ...
        return (
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 px-6 py-4 rounded-lg border-2 border-gray-300 bg-white text-gray-900 font-medium focus:outline-none hover:bg-stone-900 hover:text-slate-100 hover:border-blue-400 focus-visible:bg-stone-900 focus-visible:text-slate-100 focus-visible:border-blue-500 focus-visible:ring-4 focus-visible:ring-blue-300 transition-colors"
          >
            <Icon size={24} />
