...
const ClassDetailsPage: React.FC = () => {
  ...
  const classInfo = {
    ...
    description: 'Introduction to Algebra, Calculus, and Geometry. This course covers the fundamental concepts required for advanced mathematical studies.',
  };
    ...
    <div className={styles.container}>
      ...
      <header className={styles.header}>
        ...
        <div className={styles.toggleContainer}>
          <button
            className={`${styles.toggleBtn} ${viewMode === 'subject' ? styles.toggleBtnActive : ''}`}
            onClick={() => setViewMode('subject')}
          >
            Subject
          </button>
          <button
            className={`${styles.toggleBtn} ${viewMode === 'topic' ? styles.toggleBtnActive : ''}`}
